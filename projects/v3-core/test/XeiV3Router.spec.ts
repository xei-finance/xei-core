...
describe('XeiV3Pool', () => {
  ...
  let pool0: MockTimeXeiV3Pool
  let pool1: MockTimeXeiV3Pool
  ...
  let swapTargetCallee: TestXeiV3Callee
  let swapTargetRouter: TestXeiV3Router
