...
import '../v3-core/interfaces/callback/IXeiV3FlashCallback.sol';
...
/// @notice An example contract using the Xei V3 flash function
contract PairFlash is IXeiV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `xeiV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        ...
        IXeiV3Pool pool = IXeiV3Pool(PoolAddress.computeAddress(factory, poolKey));
