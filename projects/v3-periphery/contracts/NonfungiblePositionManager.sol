...
/// @title NFT positions
/// @notice Wraps Xei V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the xei position
    struct Position {
    ...
    ) ERC721Permit('Xei V3 Positions NFT-V1', 'Xei-V3-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
