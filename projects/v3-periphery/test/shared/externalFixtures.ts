...
} from '../../../v3-core/artifacts/contracts/XeiV3Factory.sol/XeiV3Factory.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { IXeiV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain'
...
const v3CoreFactoryFixture: Fixture<IXeiV3Factory> = async ([wallet]) => {
