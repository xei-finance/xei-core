...
describe('NFTDescriptor', () => {
  ...
  describe('#constructTokenURI', () => {
    ...
    function constructTokenMetadata(
      ...
      return {
        name: `Xei - ${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
        description: `This NFT represents a liquidity position in a Xei V3 ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
